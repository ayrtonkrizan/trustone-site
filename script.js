document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    ...
    en: {
      ...
      hero_description: "Approvals in seconds.<br>Simple, secure and 100% integrated with your ERP.<br>Less bureaucracy, more speed, immediate results.",
      showcase_subtitle: "The fastest, most modern and safest way to approve purchases, sales, contracts, expenses and requests — directly from your cell phone.",
      process_title: 'How does the <span class="highlight">approval</span> process work?',
      step1_title: "1. Order Generation",
      step1_desc: "The order (purchase, sale, expense) is generated in your ERP system.",
      step2_title: "2. Immediate Notification",
      step2_desc: "The responsible manager receives the notification in the TrustHub application.",
      step3_title: "3. Approval in Seconds",
      step3_desc: "The manager approves or rejects the request with a tap on the cell phone.",
      step4_title: "4. Automatic Synchronization",
      step4_desc: "The decision is automatically synchronized with your ERP, finishing the process.",
      ...
      feature2_desc: "Immediate approval with one touch, through a simple and intuitive interface.",
      feature2_item1: "Simple and intuitive interface",
      feature2_item2: "Immediate one-touch approval",
      feature3_title: "Security and Reach",
      feature3_desc: "Google-level security.<br>Support for multiple languages for global teams.",
      feature3_item1: "Security with Google technology",
      ...
      benefit1_item2: "❌ Elimination of operational bottlenecks",
      benefit2_title: "Financial<br> Impact",
      benefit2_item1: "💼 Improved cash flow",
      benefit2_item2: "💰 Reduced costs with SAP/Cloud licenses",
      benefit3_title: "Governance and Tracking",
      ...
      migration1_desc: "Does not require SAP/Cloud license and has RESTful API.",
      migration1_item1: "🔒 No SAP/Cloud license needed",
      migration1_item2: "⚙ RESTful API to facilitate your integration",
      migration2_title: "Performance and UX",
      migration2_desc: "Built with Google technology for high performance, with a modern and easy-to-use interface.",
      migration2_item1: "🌐 High-performance Google technology",
      migration2_item2: "📱 Modern and easy-to-use interface",
      migration3_title: "Customization and Agility",
      migration3_desc: "Customizable appearance, configurable rules and instant approvals.",
      migration3_item1: "🧮 Customized cards",
      migration3_item2: "⚡ Configurable theme",
      migration3_item3: "🛠 Multi-language",
      target_title: 'Who is <span class="highlight">TrustHub</span> for?',
      target_subtitle: "Ideal for companies that:",
      target_item1: " Have multiple approval levels",
      target_item2: " Have external or traveling managers",
      target_item3: " Want to reduce license costs",
      target_item4: " Need to speed up purchases, sales and finance",
      ...
      contact_subtitle: "Fill out the form and our team will contact you",
